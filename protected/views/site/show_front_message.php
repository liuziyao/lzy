...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <style type="text/css">
            ...
            *{ padding: 0; margin: 0; }
            ...
            .system-message{ width:500px;height:100px; margin:auto;border:6px solid #999;text-align:center; position:relative;top:50px;z-index: 99999}
    ...
    <body>
        ...
        <fieldset class="system-message">
            ...
            <div style="text-align:left;padding-left:10px;height:75px;width:490px; background:white ">
